...
export default () => {
  const cards = [
    {
      imageSrc:
        "https://miro.medium.com/v2/resize:fit:640/format:webp/1*F8eOe152tN23kM521-IDZg.png",
      type: "Beachfront",
      pricePerDay: "$99",
      title:
        "How to Set Up a Virtual Environment with Vagrant and VMware on MacOS(Apple Silicon)",
    ...
    },
    {
      ...
      pricePerDay: "$169",
      title:
        "Creating and Accessing Linux Virtual Machine Instance on Google Cloud Platform",
      trendingText: "Trending",
        ...
        <ThreeColumn>
          <HeadingColumn>
            <HeadingInfoContainer>
              <HeadingTitle>Trending articles</HeadingTitle>
              <HeadingDescription>
                Read stories about Virtual Machine on Medium. Discover smart,
                unique perspectives on Virtual Machine and the topics that
                matter most to you like Docker, ...
              </HeadingDescription>
              <PrimaryLink>
